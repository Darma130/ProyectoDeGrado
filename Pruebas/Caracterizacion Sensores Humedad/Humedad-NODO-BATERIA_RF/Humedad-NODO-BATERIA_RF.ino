...
#define MUESTRAS_HUM 1 //CANTIDAD DE MUESTRAS A TOMAR POR CICLO DE PROMEDIOS
#define SENSOR_HUMEDAD A0 //PIN ADC PARA EL SENSOR DE HUMEDAD
#define POW_HUM 3 //alimentacion sensor humedad
...
void setup() {
  ...
  t.after(1, Humedad); //SE ESPERA UN TIEMPO MUERTO DE 2 MINUTOS MIENTRAS EL SENSOR SE ESTABILIZA E INICIA A ADQUIRIR MEDIDAS ALREDEDOR DE UN VALOR
